...
of available country-level income-quintile expenditures, renormalized to 100
...
The final group-specific HICP weights are obtained by normalizing the calibrated aggregate mass
within each group:
\begin{equation}
\omega_{j,g,y}
=
...
weights normalized over the matched product set:
\begin{equation}
