...
We next pool individual household records from the euro area to examine whether
differences in consumption baskets translate into systematic differences in inflation exposure.
The harmonised specification applies the same household-level variables and price-matching method
...
The income gradient changes sign over time. Relative to the first quintile, households in the upper
...
negative and statistically significant, ranging from $-0.63$ to $-0.85$ percentage point, with the
largest difference for the fifth quintile. The coefficients remain negative in 2023, between
$-0.15$ and $-0.22$ percentage point. In the pooled specification, they range from $-0.24$ to
$-0.29$ percentage point and are all statistically significant. Thus, higher-income households had
...
$-0.89$ and $-0.30$ percentage point. The pooled coefficients preserve this age gradient, ranging
from $-0.40$ percentage point for ages 45--59 to $-0.95$ for households under 30.
...
Location differences are concentrated in 2021--22. Conditional on the other covariates and country
...
rural--city ordering temporarily reversed in 2023. In household-level regressions for the euro area,
