...
cumulative inflation gap between the first and fifth income quintiles was 0.9 percentage point in the
...
income quintile. Counterfactual indices indicate that household price policies---tariff shields,
VAT and charge cuts, fuel rebates, and price caps---lowered average cumulative inflation by
1.3 percentage points and reduced the
income-quintile inflation gap by 0.7 point in the 20-country aggregate.
...
aggregate gap to 0.9 percentage point. The inflation burden, which scales inflation by
...
the rural--city ranking temporarily reversed in 2023. In household-level regressions, residence density is the most consistent correlate of
inflation exposure, whereas the associations with income brackets and age vary across years.
...
\cite{accardo2023measuring} that estimates consumption inequality between waves}. The most recent
...
This reflects both the first quintile's exposure to price increases in essential categories and
its higher consumption-to-income ratio. The burden measure therefore amplifies the distributional
contrast that is only partly visible in inflation-rate gaps: the average burden from 2020 to 2026
is about twice as high for the first quintile as for the fifth quintile.

\section{Effects of Household Price Policies on Inflation Inequality}
\label{sec:fiscal-policies}

This section evaluates the distributional effects of fiscal policies that directly changed consumer
prices faced by households, including broad and targeted energy price shields, VAT and charge
reductions, price caps, and fuel rebates. Income transfers and measures applying only to firms are
excluded because they do not directly change the prices entering household HICP baskets.
...
\captionsetup{font=footnotesize, format=hang, singlelinecheck=false, justification=justified}
\caption*{Notes: The no-policy series removes only fiscal interventions that directly affected consumer prices faced by households; income transfers and firm-only measures are excluded. The figure covers all 20 euro-area countries, aggregated using annual HICP country weights, from January 2021 to July 2026. Unit: year-on-year inflation rate, in percent.\\
...
policies and cumulative no-policy inflation for the selected country rows and the 20-country
euro-area aggregate, together with the corresponding income-quintile indices and inflation gap. The
fiscal-cost column sums targeted and untargeted household price-policy budgets; it excludes income
support and firm-only measures. Observed inflation outcomes are reported in
...
The observed Quintile 1--Quintile 5 gap is therefore 0.9 percentage point,
compared with 1.6 percentage points without the simulated measures. Under our sign convention,
the resulting policy effect of $-0.7$ percentage point means that household price policies lowered the
...
including all 20 countries, the cumulative Quintile 1--Quintile 5 gap was 0.9 percentage point. Differences by
...
Quintile 1--Quintile 5 inflation gap by 0.7 percentage point.
