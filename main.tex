...
\title{Inflation Inequalities Across the Euro Area\thanks{This paper presents the authors' views and should not be interpreted as reflecting the views of
 the Banque de France or the Eurosystem. This article is accompanied by an R package that allows users to replicate the results or make new calculations. This paper is based on HBS public and microdata from Eurostat. The responsibility for all conclusions drawn from the data lies entirely with the authors. We thank Pradana Aumars and Lyna El Kamel for excellent research assistance.}}
