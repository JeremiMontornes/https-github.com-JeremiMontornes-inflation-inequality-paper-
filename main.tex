...
Inflation burdens relative to income were nevertheless substantially larger for the first
...
shock, but also a large relative-price shock, initially driven by imported energy and commodity prices. Its
...
The inflation burden, expressed as a percentage of income, was much larger for the first quintile than for the fifth quintile.
...
and harmonisation challenges that motivate the
...
not directly express the cost of inflation relative to household resources. We compute an
inflation burden indicator by scaling inflation by the consumption-to-income ratio
of group $g$ at the country level. The available harmonized inputs do not support a comparable
household-level burden calculation across all countries. Let $\kappa_{g,y'}$ denote consumption expenditure as a percentage of disposable
...
governments in the euro euro-area relied predominantly on  measures that directly reduced consumer energy prices
rather than on narrowly targeted income support \citep{sgaravatti2021national}.  We use  \cite{sgaravatti2021national}'s dataset 
\footnote{https://www.bruegel.org/dataset/national-policies-shield-consumers-rising-energy-prices}
 to identify the price-relevant measures and dates, we
construct counterfactual HICP component paths without those interventions. In the Bruegel inventory for
the 20 euro-area countries, 142 of 207 household price measures (68.6 percent) were untargeted,
while 65 measures (31.4 percent) were targeted at vulnerable households.
...
\]
More generally, when the source inventory identifies a subsidy but does not supply a monthly unit
price, we set $s_{k,t}=\delta_k\bar P_j$ in component-index units. This yields the time-varying ratio
$1+\delta_k\bar P_j/P_{j,t}$. The single parameter $\delta_k$ is calibrated so that the geometric
...
household groups: the within-year Laspeyres change are chain-linked at the household level, and
...
We ewamined the effect of by income quintile, age,  household size, and degree of urbanisation on household-specific inflation.
...
The income brackets changes sign over time. Relative to the first quintile, households in the upper
...
2021 and June 2023. Using the same endpoints and chained-index method, the cumulative gap was 1.3
...
energy-price surge rather than persistent: both gaps subsequently narrowed, and the rural--city
...
Income groups alone do not identify vulnerable households: exposure also depends on residence or age that capture 
 heating technology,  mobility constraints, or substitution possibilities of households between products.
