...
December price index of the previous year. The agregation procedure is flowwing: item indices are first unchained within the
...
surge did not translate into  inflation inequality by income quintile
...
with different price dynamics and fiscal responses. The  long-run
inflation inequality between top and bottom income quintile is reported in Figure~\ref{fig:ea20_long_run_income}. 
Inflation differentials by age and residence area are available in appendix for France 
(see Appendix Figure~\ref{fig:app-additional-figures}). 
...
There is significant heterogeneity among countries within the euro area. The 2022--23 inflation episode was marked by a large gas price shock following Russia's invasion of Ukraine, with uneven exposure across countries depending on their energy mix, import dependence, and policy responses. Figure~\ref{fig:country_heterogeneity} provides a comparison of inflation by income quintiles across different groups of countries in 2022. Panel (a) focuses on Estonia, Lithuania, Latvia, and Slovakia, revealing significant inflation differentials, particularly in the lower quintile. Panels (b), (c), and (d) present data for Austria, Finland, Luxembourg, and the Netherlands; Greece, Ireland, Portugal, and Cyprus; and Germany, France, Italy, and Spain, respectively. The figures highlight the varying degrees of inflation inequality, with notable differences in the impact of energy and food prices on different income groups. 
...
Table~\ref{tab:oil-gas-shock} shows that a crude-oil and gas input-price shock mainly affects household prices through indirect production-network channels rather than through direct household energy consumption alone. The simulated average effect is largest in the Netherlands and Italy, while the income-quintile gaps remain small relative to the aggregate shock. By contrast, rural-urban gaps are systematically positive, consistent with stronger exposure of rural households to energy-intensive consumption and transport needs.
